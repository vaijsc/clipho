...
TRAINING_CMD="torchrun --nproc_per_node=8 --nnode=1 src/run_vision_encoder.py \
    --output_dir /lustre/scratch/client/movian/research/groups/datnqgroup/dungnn28/NLP_working/VLM/saves/google_siglip-base-patch16-384_phobert_syllable_base_512_image_27M_all_stage-2_no_gemini \
    --model_name_or_path /lustre/scratch/client/movian/research/groups/datnqgroup/dungnn28/NLP_working/VLM/saves/google_siglip-base-patch16-384_phobert_syllable_base_512_image_27M_all_stage-1_no_gemini/checkpoint-34079 \
